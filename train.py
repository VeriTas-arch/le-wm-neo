...
def run(cfg):
    ...
    with open_dict(cfg):
        for col in cfg.data.dataset.keys_to_load:
            if col.startswith("pixels") or col.startswith("cue") or col.startswith("action"):
                continue
    ...
    val = torch.utils.data.DataLoader(val_set, **cfg.loader, shuffle=False, drop_last=False, collate_fn=custom_collate)
